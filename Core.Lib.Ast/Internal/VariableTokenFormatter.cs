...
namespace Core.Lib.Ast.Internal
{
    ...
    /// </summary>
    internal class VariableTokenFormatter : IVariableTokenFormatter
    {
        private VariableTokenOptions _options;


        private string NullValue => $"{_options.LeftQuotes}{_options.Null}{_options.RightQuotes}";
        private static readonly object[] EmptyArray = new object[0];
        private char[] FormatDelimiters => _options.Seperators;
        private readonly string _format;
        private readonly List<string> _valueNames = new List<string>();
        public VariableTokenFormatter(VariableTokenOptions options, string format)
        {
            ...
            {
                var openBraceIndex = FindBraceIndex(format, _options.LeftQuotes, scanIndex, endIndex);
                var closeBraceIndex = FindBraceIndex(format, _options.RightQuotes, openBraceIndex, endIndex);
