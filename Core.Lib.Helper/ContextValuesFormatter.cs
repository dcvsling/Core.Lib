...
namespace Core.Lib.Helper
{
    ...
    /// </summary>
    internal class ContextValuesFormatter
    {
        ...
        public ContextValuesFormatter(string format)
        {
        ...
        public string Format<T>(T context)
        {
            var args = new List<string>();
            foreach (var name in ValueNames)
            {
                args.Add(name.Parse<T, string>().Invoke(context));
            }
